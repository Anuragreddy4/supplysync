...
export default function BuyerProfilePage() {
  ...
  return (
    <div className="max-w-2xl mx-auto" id="buyer-profile">
      <motion.h1
        ...
        <ElevatedCard className="mb-6">
          <div className="flex items-center gap-4">
            {user?.photoURL ? (
              ...
              <div className="w-16 h-16 rounded-2xl bg-buyer-soft flex items-center justify-center">
                <User className="w-7 h-7 text-buyer" />
              </div>
            )}
            <div>
              <h2 className="font-jakarta font-bold text-heading text-lg">{user?.displayName || "Buyer"}</h2>
              <p className="text-muted text-sm">{user?.email}</p>
              <span className="inline-flex items-center gap-1 text-xs font-medium text-buyer mt-1">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-3 rounded-xl border border-gray-200 text-heading text-sm bg-white focus:border-buyer focus:ring-2 focus:ring-buyer-ring outline-none transition-all"
              >
            ...
            <div>
              ...
              <div className="relative">
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full pl-10 pr-4 py-3 rounded-xl border border-gray-200 text-heading text-sm placeholder:text-subtle focus:border-buyer focus:ring-2 focus:ring-buyer-ring outline-none transition-all resize-none"
                />
              </div>
            </div>
